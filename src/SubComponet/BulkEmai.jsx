...
<div className="row mt-5">
  <div className="col p-5 " style={{ backgroundImage: 'url(https://rcsinfo.in/img/about.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat',height:'200px' }}>
        <span className='text-danger'>Home</span> <span className='text-danger'>Web Developement</span> <span>Dynamic Website</span>
        <h3 className='p-4'>Dynamic Website</h3> 
  </div>
</div>
{/* image div ends */}
...
<div className="row-12">
    <div className="container p-4">
        <h2>Dynamic Website Development Services</h2>
    </div>
</div>
{/* main heading ends */}
